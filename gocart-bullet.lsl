...
vector  gSitTarget_Pos = <0.25,0.0,0.51>;
vector  gSitTarget_Rot;
key     gOldAgent;
key     gAgent;
integer gRun;     //ENGINE RUNNING
integer gMoving;  //VEHICLE MOVING
string gDrivingAnim = "9c970947-b84b-4f0e-8f42-67e3c81584fe";
integer gCamFixed=0;             // INITVAL=0            0=FOLLOW CAM 1=FIXED CAM
string  gSoundFlight = "2b07352b-f6ee-413b-bc34-55126a06704f";
string  gSoundHorn = "b64946aa-8e89-4b66-8b0f-cdeba250fcb4";
string  gSoundStartup = "e7b4c233-2e2d-49db-a134-773bf48976b4";
string  gSoundIdle = "6d11b49c-dc58-4f13-b63a-902daab38099";
string  gSoundSlow = "d8cdda52-c68f-434f-bcf9-fb4663247460";
string  gSoundAggressive = "d8cdda52-c68f-434f-bcf9-fb4663247460";
string  gSoundGearUp = "19b837c5-41fb-47e2-ba85-00cf7958c305";
string  gSoundGearDown = "81b6b972-79d1-41fa-aba0-cc858276149a";
string  gSoundRev = "159f1e2d-c232-4b4a-8b87-822bdb3153d5";
string  gSoundAlarm = "3be633c1-dba3-4aa5-8dc8-fbebd5903a1c";
string  gSoundStop = "1095a25b-4bb4-4ca7-ba4e-3da5ad7b2f0d";
...
set_engine()
{
    ...
    llSetVehicleRotationParam(VEHICLE_REFERENCE_FRAME, <0.00000, 0.00000, 0.00000, 1.00000>);
...
//                llDie();
    ...
    control(key id, integer held, integer change)
    {
        ...
        showdata("Speed:" + (string)(gSpeed*2.23692912) + " mph");
        enginesound();
