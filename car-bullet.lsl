...
vector          gSitTarget_Pos = <-0.4,0.45,0.4>;
...
init_PhysEng(){
    ...
    if(gPhysEng==0){
        ...
        msg =":: You can say open close roof or motor, Have fun ;-)";
    }
...
init_followCam(float degrees){
    llSetCameraParams([
                       ...
                       CAMERA_DISTANCE, 9.0,             // ( 0.5 to 10) METERS
                       ...
                       CAMERA_FOCUS_OFFSET, <0.10,0,0>   // <-10,-10,-10> to <10,10,10> METERS
                        ...
                        llSetCameraEyeOffset(<-10, 0, 3.0> * sitRot);
                        llSetCameraAtOffset(<5, 0, 2.5> * sitRot);
